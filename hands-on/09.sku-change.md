...
관찰 중 VM 이름이나 리소스 ID가 다르면 **`vm-{본인ID}` 조건 수정 필요**함.
...
관리 디스크는 선택한 계층의 **월 가격을 시간 단위로 비례 계산**하여 청구함.  
...
1. Azure Portal에서 **가상 머신** > `vm-{본인ID}` > **설정** > **디스크**로 이동함.  
...
![](images/2026-08-19-17-24-24.png)  
...
- Disk 분리
  ![](images/2026-08-19-18-45-04.png)

- 포탈 홈에서 Disk 선택 후 설정 > 크기 + 성능 선택 
  ![](images/2026-08-19-18-17-55.png)  

- 8GiB로 변경 후 하단 '저장' 클릭
  ![](images/2026-08-19-18-18-26.png)  

- VM의 설정 > 디스크에서 기존 디스크 연결 클릭 > 디스크 이름 선택 후 사이즈 변경 확인  
  ![](images/2026-08-19-18-46-16.png)    
