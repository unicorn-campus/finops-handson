# 01. Summary — 전체 개요 대시보드(총 실질비용·절감·최대 비용원 한눈에)

> 페이지: Summary · 데이터 범위: 청구기간 2024-06-01 ~ 2024-07-08 · 필터 전체(All) · 통화 USD(샘플)  
> 원본: CostManagementConnector.pbix (FinOps Toolkit) · Inform 단계 비용 가시화  
> 📌 한 줄 요약(TL;DR): 이번 기간 실질비용 81.1천·절감 1.08천이며, FTK Fabric이 비용의 절반으로 최우선 최적화 대상임.

![](./01.summary.png)

## 1. 개요
- 보고서의 표지이자 대시보드로 "이번 기간에 총 얼마 썼고 얼마 아꼈나"를 한눈에 보는 화면임  
- 데이터 범위: 청구기간 `2024-06-01 ~ 2024-07-08` / 필터 Subscription·Region·Commitment discount·Service·Currency 모두 All / 통화 USD(샘플)
...
- 총 실질비용 **81.1천**(≈81,100), 총 절감 **1.08천**(≈1,080) → 절감률 약 **1.3%**  
- 누적 곡선은 6월 2일 0에서 시작해 매일 조금씩 쌓여 12천 → 27천 → 50천 → 81천으로 우상향(7월 7일 81천)  
- 가장 큰 구독은 **FTK Fabric**: 6월 33,178 + 7월 8,755 = **41,933**로 전체 비용의 절반 이상  
- 두 번째 **Cost Management Research**: 합계 **14,455**, 이 구독만 할인 절감(267+101) 발생 → RI/협상 할인이 적용된 유일 구독  
...
- 절감률 약 **1.3%**로 할인 활용이 아직 미미함 → 최적화 여지가 큼  
- **FTK Fabric 하나가 비용 절반**을 차지 → 여기부터 파고들면 절감 효과 최대  
- 대부분 구독의 절감액이 0 → 약정(RI/SP)·협상 할인이 거의 안 걸린 **할인 사각지대** 존재 → Optimize 단계 과제  
- 추이 곡선이 매끈하면 안정적, 급등 구간이 있으면 그날 신규 배포 등 원인 조사가 필요한 **이상 신호**임

## 5. 권고사항
> Now what · Inform 단계 실행 행동(실행은 Optimize 이관 명시)

- **1순위: FTK Fabric 집중 분석** — 비용 절반을 차지하므로 서비스별(02번)·리소스별(05번) 드릴다운으로 원인 규명  
- **할인 사각지대 해소** — 절감액 0인 구독을 대상으로 약정(RI/SP)·협상 할인 적용 여지 검토 → Inform → **Optimize 이관 포인트**  
- **추이 이상 감시** — 누적 곡선 급등 구간 발견 시 배포 이력·예산 대비 점검  
- **약정 구매 시 원칙 준수** — 아래 섹션6 보충의 "권장값의 ~70%까지, 3일 간격 분할 구매·기저부하만 커버" 공식을 적용해 미활용 위험 최소화(Optimize 이관 시 적용할 구매 원칙)

## 6. 용어·출처

### 용어
- **Effective cost(실질 비용)**: 할인이 모두 적용된 뒤 실제 부담 비용  
- **Total savings(총 절감액)**: 협상 할인 + 약정 할인 절감의 합  
- **Negotiated savings(협상 할인 절감)**: 계약 단가 협상으로 아낀 금액(자동 적용)  
- **Commitment savings(약정 할인 절감)**: RI·Savings Plan 구매로 아낀 금액(능동 구매)
...
**Azure Portal에서 신청하는 법 — 약정 할인(셀프서비스, 포털 직접 구매)**
